...
Analysis of published techniques applicable to the BitZoom precomputation pipeline at 30M+ node scale.
...
**Problem:** Empty bins when |S| < k (common in BitZoom: 3-10 tokens per set).
...
**Exact within ±1 grid cell.** Indistinguishable from sort-based rank for BitZoom.
